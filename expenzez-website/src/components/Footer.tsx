        ...
        <div className="footer-container">
          ...
          <div className="footer-brand">
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
              <Smartphone size={32} style={{ color: '#8b5cf6', marginRight: '0.5rem' }} />
              <span style={{ fontSize: '1.5rem', fontWeight: '700' }}>Expenzez</span>
            </div>
            <p style={{ color: '#d1d5db', marginBottom: '1.5rem', maxWidth: '400px', lineHeight: '1.6' }}>
